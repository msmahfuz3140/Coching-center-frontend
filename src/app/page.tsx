...
export default function Home() {
  return (
    <div className="flex-1">
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-blue-50 via-white to-indigo-50">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24 lg:py-32">
          <div className="text-center">
            ...
            <p className="text-base sm:text-lg md:text-xl text-gray-600 mb-8 md:mb-10 max-w-2xl mx-auto leading-relaxed px-4 sm:px-0">
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center px-4 sm:px-0">
              ...
              <Link href="/courses" className="w-full sm:w-auto px-6 sm:px-8 py-3 sm:py-4 bg-white text-gray-900 font-semibold rounded-xl border-2 border-gray-200 hover:border-blue-500 hover:text-blue-600 transition-all duration-300 hover:-translate-y-1 text-center">
                Explore Courses
              </Link>
            </div>
          </div>
      ...
      {/* ── STATS ── */}
      <section className="relative -mt-8 md:-mt-12 z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24">
        <div className="text-center mb-12 md:mb-16">
          ...
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900 mt-2">Everything You Need to Learn</h2>
          <p className="text-gray-600 mt-4 max-w-2xl mx-auto text-sm sm:text-base px-4 sm:px-0">Our platform provides all the tools for an effective learning experience.</p>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
          {[
            ...
            <div key={f.title} className="bg-white p-6 sm:p-8 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100 group hover:-translate-y-1">
              <div className={`w-12 h-12 sm:w-14 sm:h-14 ${f.bg} rounded-xl flex items-center justify-center mb-4 sm:mb-5 group-hover:scale-110 transition-transform duration-300`}>
                <svg className={`w-6 h-6 sm:w-7 sm:h-7 ${f.fg}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <section className="bg-gray-50 py-16 md:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12 md:mb-16">
            ...
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900 mt-2">Start Learning in 4 Simple Steps</h2>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
            {steps.map((s, i) => (
              <div key={s.step} className="relative group">
                ...
                <div className="relative bg-white rounded-2xl p-5 sm:p-6 shadow-sm hover:shadow-xl transition-all duration-300 border border-gray-100 hover:-translate-y-1 z-10">
                  <div className={`w-10 h-10 sm:w-12 sm:h-12 rounded-xl bg-gradient-to-r ${s.color} flex items-center justify-center text-white text-sm font-bold mb-3 sm:mb-4 group-hover:scale-110 transition-transform duration-300`}>
                    {s.step}
                  </div>
                  <h3 className="text-base sm:text-lg font-bold text-gray-900 mb-1 sm:mb-2">{s.title}</h3>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24">
        <div className="text-center mb-12 md:mb-16">
          ...
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900 mt-2">Why Coaching Centers Choose Us</h2>
          <p className="text-gray-600 mt-4 max-w-2xl mx-auto text-sm sm:text-base px-4 sm:px-0">Everything you need to run courses and stay connected to students.</p>
        </div>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
          {[
            ...
            <div key={x.title} className="bg-white rounded-2xl border border-gray-100 shadow-sm p-5 sm:p-6 hover:shadow-lg transition-all duration-300 hover:-translate-y-1 group">
              <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-xl bg-gradient-to-br from-blue-50 to-indigo-50 flex items-center justify-center text-xl sm:text-2xl group-hover:scale-110 transition-transform duration-300">
                {x.icon}
              </div>
              <h3 className="mt-3 sm:mt-4 text-base sm:text-lg font-bold text-gray-900">{x.title}</h3>
              <p className="mt-1 sm:mt-2 text-xs sm:text-sm text-gray-600 leading-relaxed">{x.desc}</p>
            </div>
          ))}
        </div>
      </section>
      ...
      <section className="bg-gradient-to-br from-blue-50 via-white to-indigo-50 py-16 md:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12 md:mb-16">
            ...
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900 mt-2">What Our Students Say</h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
            {testimonials.map((t) => (
              <div key={t.name} className="bg-white rounded-2xl p-6 sm:p-8 border border-gray-100 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                ...
                <p className="text-gray-600 text-sm leading-relaxed mb-4 sm:mb-6">&ldquo;{t.text}&rdquo;</p>
                <div className="flex items-center gap-3">
                  <div className={`w-8 h-8 sm:w-10 sm:h-10 rounded-full bg-gradient-to-br ${t.color} flex items-center justify-center text-white text-xs sm:text-sm font-bold`}>
                    {t.avatar}
                  </div>
                  <div>
                    <p className="text-gray-900 font-semibold text-xs sm:text-sm">{t.name}</p>
                    <p className="text-gray-500 text-[10px] sm:text-xs">{t.role}</p>
                  </div>
                </div>
              </div>
            ))}
      ...
      <section className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24">
        <div className="text-center mb-12 md:mb-16">
          ...
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900 mt-2">Frequently Asked Questions</h2>
        </div>
        <div className="space-y-3 sm:space-y-4">
          {faqs.map((f, i) => (
            <details key={i} className="group bg-white rounded-xl border border-gray-200 hover:border-blue-200 transition-colors duration-200">
              <summary className="flex items-center justify-between cursor-pointer px-4 sm:px-6 py-4 sm:py-5 text-gray-900 font-medium text-sm md:text-base">
                <span className="pr-4">{f.q}</span>
                <svg className="w-4 h-4 sm:w-5 sm:h-5 text-gray-400 group-open:rotate-180 transition-transform duration-300 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" />
                </svg>
              </summary>
              <div className="px-4 sm:px-6 pb-4 sm:pb-5 text-sm text-gray-600 leading-relaxed border-t border-gray-100 pt-3 sm:pt-4">
                {f.a}
              </div>
            </details>
          ))}
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:pb-24">
        <div className="relative overflow-hidden bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-600 rounded-2xl sm:rounded-3xl p-8 sm:p-12 md:p-16 text-center text-white">
          ...
          <div className="relative">
            <h2 className="text-2xl sm:text-3xl md:text-5xl font-bold mb-3 sm:mb-4">Ready to Start Learning?</h2>
            <p className="text-base sm:text-lg mb-6 sm:mb-10 opacity-90 max-w-xl mx-auto px-4 sm:px-0">Join hundreds of polytechnic students already using our platform to ace their exams.</p>
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center px-4 sm:px-0">
